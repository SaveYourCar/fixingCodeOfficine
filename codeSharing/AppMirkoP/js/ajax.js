function get(url, successCallback, errorCallback) {
    ...
    var xhr = new XMLHttpRequest(); //crea un client http che permette le chiamate GET put etc..
  ...
  function post(url, data, successCallback, errorCallback) {
    /* 
   // questo va a ggiunto nel caso in cui i dati arrivino direttamente un form html
   var params =
      typeof data == "string"
        ? data
        : Object.keys(data)
